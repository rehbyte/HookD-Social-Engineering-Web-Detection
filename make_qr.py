"""
Generate a QR code PNG that links to your HookD site (e.g. for an exhibit booth).

Usage:
    pip install "qrcode[pil]"
    python make_qr.py http://192.168.1.50:5000        # your laptop's LAN address
    python make_qr.py https://your-app.onrender.com    # or a deployed URL
...
def main():
    if len(sys.argv) < 2:
        sys.exit("Usage: python make_qr.py <your-url>")
